...
export default function EditProduct() {
  ...
  const handleAddSize = () => {
    ...
    try {
      ...
      appendSize(newSize);
      toastSuccess(
        "Talle/número añadido, porfavor completa sus datos",
        toastId
      );
    } catch (error) {
  ...
  const handleRemoveSizeById = (sizeId, sizeName) => {
    ...
    if (index !== -1 && sizeFields.length > 1) {
      ...
      return toastSuccess(
        <>
          Talle eliminado: <strong>'{sizeName}'</strong> - id:{" "}
          <strong>'{sizeId}'</strong>
        </>,
        toastId
      );
    } else {
      toastError(
        <div className="text-center">
          <p className="mb-0">
            <strong>Minimo un talle/tamaño</strong>
          </p>
        </div>,
        toastId
      );
  ...
  const handleRemoveColorById = (sizeIndex, colorId, colorName) => {
    ...
    if (colorIndex !== -1 && sizeColors.length > 1) {
      ...
      return toastSuccess(
        <>
          Color eliminado: <strong>'{colorName}'</strong> - id:{" "}
          <strong>'{colorId}'</strong>
        </>,
        toastId
      );
    } else {
  ...
  const handlePrimaryCategoryChange = (e) => {
    ...
    if (selectedCategoryIndex !== -1) {
      ...
      setValue(
        `categories.${selectedCategoryIndex}.categoria.id`,
        selectedCategory.id
      );
      setValue(
        `categories.${selectedCategoryIndex}.categoria.name`,
  ...
  const onSubmit = async (data) => {
    ...
    try {
      ...
      toastSuccess(
        <>
          Producto editado: <strong>'{editedProduct.name}'</strong>, cantidad:{" "}
          <strong>'1'</strong>
        </>,
        toastId
      );
          ...
          <div className="row justify-content-between p-2 p-md-0 m-0">
            <div className="col-12 col-md-7 p-0 pe-md-3 mb-3 mb-md-0">
              ...
              >
                  ...
                  <div className="row rounded border col-12 p-0 py-2 mx-auto">
                    ...
                    <div className="d-flex flex-column mb-2">
                      ...
                      <input
                        type="text"
                        className="form-control fontSM-Custom custom-placeholder"
                        placeholder="Descubre nuestra remera oversize, diseñada para ofrecerte máxima comodidad..."
                      ...
                      <div className="col d-flex flex-column mb-2">
                        ...
                        <Controller
                          ...
                          rules={{
                            ...
                            validate: {
                              positive: (value) =>
                                value > 0 || "El valor debe ser positivo",
                              maxLength: (value) =>
                        ...
                        categories.length > 0 ? (
                          categoryFiels.map((cat, categoryIndex) => (
                            <div key={cat.id}>
                                  ...
                                  `categories.${categoryIndex}.categoria.id`,
                                  {
                                    ...
                                    validate: (value) => {
                                      if (
                                        ...
                                        const categorieFind = categories.find(
                                          (c) => c.id == value
                                        );
                                        // console.log("name in obj", getValues(`categories.${categoryIndex}.categoria.name`));
                                        setValue(
                                          `categories.${categoryIndex}.categoria.name`,
                                          categorieFind.name
                                        );
                                      }
                                    },
                              ...
                              {errors.categories?.[categoryIndex]?.categoria
                                ?.id && (
                                <span className="mt-1 fontXS-Custom text-danger">
                                  {
                                    errors.categories?.[categoryIndex]
                                      ?.categoria.id?.message
                                  }{" "}
                                  <span className="fw-semibold">*</span>
                                </span>
                              )}
                        ...
                        categories.length > 0 ? (
                          categoryFiels.map((cat, categoryIndex) => (
                            <div key={cat.id}>
                                  ...
                                  `categories.${categoryIndex}.subCategoria.id`,
                                  {
                                    ...
                                    validate: (value) => {
                                      ...
                                      if (!sub) {
                                        ...
                                        setValue(
                                          `categories.${categoryIndex}.subCategoria.name`,
                                          sub.name
                                        );
                                      }
                                    },
                              ...
                              {/* siempre se condciona el mensaje de error hacia el campo especifico del error  */}
                              {errors.categories?.[categoryIndex]?.subCategoria
                                ?.id && (
                                <span className="mt-1 fontXS-Custom text-danger">
                                  {
                                    errors.categories?.[categoryIndex]
                                      ?.subCategoria.id?.message
                                  }{" "}
                                  <span className="fw-semibold">*</span>
                                </span>
                              )}
                      ...
                      {categories ? (
                        categories.length > 0 ? (
                          categoryFiels.map((cat, categoryIndex) => (
                            <div key={cat.id}>
                              <select
                                ...
                                aria-label="Default select example"
                                {...register(
                                  `categories.${categoryIndex}.subSubCategoria.id`,
                                  {
                                    required: {
                                      value: true,
                                    ...
                                    validate: (value) => {
                                      ...
                                      if (!subsub) {
                                        console.log(
                                          "error en validate terciary"
                                        );
                                        return "Opcion invalida-subsub";
                                      } else {
                                        setValue(
                                          `categories.${categoryIndex}.subSubCategoria.name`,
                                          subsub.name
                                        );
                                      }
                                    },
                          ...
                          <>
                            ...
                            {errors.terciaryCategory && (
                              <span className="mt-1 fontXS-Custom text-danger">
                                {errors.terciaryCategory.message}{" "}
                                <span className="fw-semibold">*</span>
                              </span>
                            )}
                          </>
                ...
                <div className="row mb-3">
                  ...
                  {sizeFields.map((size, sizeIndex) => (
                    <div
                      key={size.id}
                      id={size.id}
                      className="row rounded border col-12 p-0 py-2 mx-auto mb-2"
                    >
                      {/* NUMERO */}
                      <div className="col-12 d-flex flex-column mb-2">
                        <label
                          htmlFor=""
                          className="d-flex mb-1 mx-auto fw-semibold textGray500-Custom fontSM-Custom"
                        >
                          ...
                          <button
                            onClick={() =>
                              handleRemoveSizeById(
                                size.id,
                                getValues(`sizes.${sizeIndex}.name`)
                              )
                            }
                            type="button"
                        ...
                        {/* siempre se condciona el mensaje de error hacia el campo especifico del error  */}
                        {errors.sizes?.[sizeIndex]?.name && (
                          <span className="mt-1 fontXS-Custom text-danger">
                            {errors.sizes[sizeIndex]?.name?.message}{" "}
                            <span className="fw-semibold">*</span>
                          </span>
                        )}
                      </div>
                      ...
                      {/* COLOR */}
                      {watch(`sizes[${sizeIndex}].colors`).map(
                        (col, colorIndex) => (
                          <div key={col.id} className="row col-12 mx-auto">
                            {/* <div className='col-6 d-flex row mb-2 p-0 pe-1'>
                                                        <label htmlFor="" className='d-flex mb-1 fw-semibold textGray500-Custom fontSM-Custom'>
                                                            Color
                                                        </label>
                            ...
                            <div className="col-6 d-flex flex-column mb-2 p-0 pe-1">
                              ...
                              <div className="d-flex gap-1 align-items-center">
                                <input
                                  ...
                                  placeholder="Azul"
                                  {...register(
                                    `sizes.${sizeIndex}.colors.${colorIndex}.name`,
                                    {
                                      required: {
                                        value: true,
                                        message: "Elige un nombre",
                                ...
                                <input
                                  ...
                                  {...register(
                                    `sizes.${sizeIndex}.colors.${colorIndex}.value`,
                                    {
                                      required: {
                                        value: true,
                              ...
                              {errors.sizes?.[sizeIndex]?.colors?.[colorIndex]
                                ?.name && (
                                <span className="mt-1 fontXS-Custom text-danger">
                                  {
                                    errors.sizes[sizeIndex]?.colors?.[
                                      colorIndex
                                    ].name.message
                                  }{" "}
                                  <span className="fw-semibold">*</span>
                            ...
                            <div className="col-6 d-flex flex-column mb-2 p-0 ps-1">
                              ...
                              <div className="d-flex gap-1">
                                <input
                                  ...
                                  placeholder="10"
                                  {...register(
                                    `sizes.${sizeIndex}.colors.${colorIndex}.stock`,
                                    {
                                      required: {
                                        value: true,
                ...
                {/* IMAGEN */}
                {/* <div className='row mb-3'>
                                    <p className='col-12 mb-2 text-center fw-semibold textGray500-Custom fontSM-Custom'>Multimedia</p>
                                    <div className='row rounded border col-12 p-0 py-2 mx-auto mb-2'>
                                        <div className='col-12'>
                                            <label htmlFor="image" className='d-flex mb-1 fw-semibold textGray500-Custom fontSM-Custom'>
                                                Imagen
                                            </label>
