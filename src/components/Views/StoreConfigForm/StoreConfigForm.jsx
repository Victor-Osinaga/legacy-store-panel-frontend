                                    ...
                                    <div className="row mb-3 gap-3">
                                        ...
                                        <div className="row rounded border col-12 p-0 py-2 mx-auto">
                                            <div className='d-flex flex-column'>
                                                <label htmlFor="colors.secondaryColorStore" className='d-flex mb-1 fw-semibold textGray-Custom fontSM-Custom'>
                                                    Color secundario (fondo de tarjeta de producto o cualquier elemento sobresaliente)
                                                </label>
                                        ...
                                        <div className="row rounded border col-12 p-0 py-2 mx-auto">
                                            <div className='d-flex flex-column'>
                                                ...
                                                <div className="d-flex gap-3 align-items-center">
                                                    <input type="color" className="form-control h-100 form-control-sm form-control-color" id="colors.tertiaryColorStore" title="Elige un color" {
                                                ...
                                                {errors.colors?.tertiaryColorStore && <span className='mt-1 fontXS-Custom text-danger'>{errors.colors?.tertiaryColorStore.message} <span className='fw-semibold'>*</span></span>}
                                            </div>
                                        </div>
                                    </div>
