...
import getShipingLocalById from "../../../services/shipmentsLocal/getShipmentLocalById.js";
import updateShipmentLocalById from "../../../services/shipmentsLocal/updateShimpentLocalById.js";

export default function EditarSucursal() {
    const { shipmentLocalId } = useParams();
    ...
    const onSubmit = async (data) => {
        ...
        try {
            const updatedShipmentLocal = await updateShipmentLocalById(shipmentLocalId, data)
            console.log("updatedShipmentLocal", updatedShipmentLocal);
            
            return toastSuccess(<>Sucursal editada: <strong>'{updatedShipmentLocal.province}'</strong> - id: <strong>'{updatedShipmentLocal.id}'</strong></>, toastId)
            // return toastSuccess(<>Sucursal editada: <strong>'DASDSA'</strong> - id: <strong>'SDASDASDADSASDA'</strong></>, toastId)
        } catch (error) {
            toastError(
        ...
        <>
            <section className="containerViewMain">
                <div className='d-flex justify-content-between align-items-center w-100'>
                    <div>
                        <h3 className='fs-4 mainTitle'>Editar Sucursal</h3>
                    </div>
                </div>
