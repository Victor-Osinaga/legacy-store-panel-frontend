...
export default function CreateSotreConfig() {
        ...
        <>
            <section className='containerViewMain'>
                <div className='d-flex justify-content-between align-items-center w-100'>
                    <div>
                        <h3 className='fs-4 mainTitle'>Estilos de tu tienda</h3>
                    </div>
                </div>
                            ...
                            <div className="col-12 col-md-7 p-0 pe-md-3 mb-3 mb-md-0">
                                <form onSubmit={handleSubmit(onSubmit)} className='bg-white border px-4 py-4 rounded'>
                                    ...
                                    <div className="row mb-3">
                                        <p className='col-12 mb-2 text-center fw-semibold textGray-Custom fontSM-Custom'>Info</p>
                                        <div className='row rounded border col-12 p-0 py-2 mx-auto'>
                                            <div className='d-flex flex-column mb-2'>
                                                <label htmlFor="nombre" className='d-flex mb-1 fw-semibold textGray-Custom fontSM-Custom'>
                                                    Nombre de la configuracion de estilos
                                                </label>
                                    ...
                                    {/* apiKeyMp */}
                                    {/* <div className="row mb-3">
                                        <p className='col-12 mb-2 text-center fw-semibold textGray-Custom fontSM-Custom'>Mercado Pago</p>
                                        <div className='row rounded border col-12 p-0 py-2 mx-auto'>
                                            <div className='d-flex flex-column mb-2'>
                                                <label htmlFor="nombre" className='d-flex mb-1 fw-semibold textGray-Custom fontSM-Custom'>
                                    ...
                                    <div className='row'>
                                        <div className='row col-12 p-0 py-2 mx-auto'>
                                            <button type="submit" className="btn btn-primary w-100 btn-sm fontSM-Custom">GUARDAR ESTILOS</button>
                                        </div>
                                    </div>
                                </form>
                            </div>
