...
export default function Header() {
    const { user, toastLoading, toastSuccess, toastError, dismissToast, setUser, setIsAuthenticated } = useStoreContext()
    ...
    return (
        <header id='header' className='d-flex custom-gradient'>
